...
function educationCommand(): CommandResult {
  return {
    ...
    content: [
      ...
      '  {{accent}}Period:{{/accent}}       {{date}}Jul 2022 — Jun 2026{{/date}}',
      '  {{accent}}CGPA:{{/accent}}         {{bold}}6.42{{/bold}}',
      '',
      ...
      '  {{accent}}Field:{{/accent}}        Civil Engineering',
      '  {{accent}}Institution:{{/accent}}  Sevdie Institute of Management And Technology',
      '  {{accent}}Location:{{/accent}}     Lucknow, India',
      '  {{accent}}Period:{{/accent}}       {{date}}Jul 2019 — Aug 2022{{/date}}',
      '  {{accent}}Score:{{/accent}}        {{bold}}69.72%{{/bold}}',
      '',
    ],
  };
}
...
function contactCommand(): CommandResult {
  return {
    ...
    content: [
      '',
      '  {{accent}}Email:{{/accent}}      vermaaditya3030@gmail.com',
      '  {{accent}}Phone:{{/accent}}      +91 9511493424',
      '  {{accent}}GitHub:{{/accent}}     github.com/Vermaaditya3030',
      '  {{accent}}LinkedIn:{{/accent}}   linkedin.com/in/aditya-verma-56b374268',
      '',
